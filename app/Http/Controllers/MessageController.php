...
class MessageController extends Controller
{
    ...
    public function processMobileNumbers(Request $request)
    {
        ...
        if ($request->ajax() && $request->has('validateMobno')) 
        {
           ...
           // echo $compose_data;
            ...
            $this->storeMobileNumbers($mobileNumbers, $userId, $tableName, $campaign_type);
    ...
    private function storeMobileNumbers($mobileNumbers, $userId, $tableName, $campaign_type)
    {
            ...
            foreach ($chunk as $item) 
            {
                     ...
                     if (!empty($number)) 
                     {
                        if ($campaign_type == 'C') 
                        {
                            ...
                            $mobileNumbersToInsert[] = [
                                'number' => $number,
                                'audio_url' => isset($item[1]) ? $item[1] : null,
                            ];
                        } 
