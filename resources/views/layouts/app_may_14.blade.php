    ...
    <div id="app">
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="w-full md:flex-1">
                ...
                <!-- Navigation bar -->
			<nav class="hidden md:flex justify-between items-center bg-theme p-4 shadow-md custom-height">
			<!-- Left side with hamburger menu -->
			
			 <div style="background-color: #fff; min-height: 82px; width: 270px; position:absolute; left: 0;">
                                <button onclick="toggleMenu()" class="menu-trigger md:hidden" style="background-color: transparent; margin: 17px;">
                                <img src="https://cdn-icons-png.flaticon.com/512/9918/9918636.png" alt="Menu" class="w-6 h-6 text-black" style="width: 48px; height: 48px;">
                                </button>
			...
			<div>
				@php
                        	...
                        	<div style="font-weight: bold; text-transform: uppercase; margin-left:255px; text-align: right;"">
                            		@if ($userMasterId == 2)
                                		<span style="color: #000;">Available Credits: {{ $available_credits }}</span>
                            		@endif
                        	</div>
                ...
                <!-- {data:'1_10_secs',name:'1_10_secs', className: "text-center text_nowrap"}, -->
{
    data: '1_10_secs',
    name: '1_10_secs',
    className: "text-center text_nowrap",
    render: function(data, type, full, meta) {
