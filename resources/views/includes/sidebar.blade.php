...
.bg-gray-100{
    ...
    .static-badge {
        ...
        /* color: black; */
        background-color: #4aa66e !important;
        color:white;
        /* Set the text color */
    }
</style>
...
<aside class="w-full md:w-64 bg-gray-100 md:min-h-screen menu_list menu-active" x-data="{ isOpen: true }":class="{ 'display': isOpen, 'no_display': !isOpen }" style="display: none;">

  <!-- <aside class="w-full md:w-64 bg-gray-800 md:min-h-screen menu_list" x-data="{ isOpen: false }":class="{ 'display': isOpen, 'no_display': !isOpen }">
<div class="flex items-center justify-between bg-white p-4 h-16" style="background-color: #fff !important;">
	...
	<img src="resources/image/icons/icons8-hamburger-48.png" alt="Menu" class="w-6 h-6 text-black">
            </svg> 
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('ivr_approve') }}" class="flex items-center">
                        ...
                        <span
                            class="mx-2 {{ Request()->is('ivr_approve') ? 'text-white' : 'text-black' }} {{ Request()->is('ivr_approve') ? 'in_active' : '' }} text-xl font-bold" style="position:absolute;margin-left:30px!important">Ivr
                            Approval</span>
                        @if ($Ivr_Data != '')
                            <span class="static-badge" style="margin-left: 180px;color:white !important;">
                                {{ $Ivr_Data }}
                            </span>
                        @endif
                    </a>
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('approve_campaign') }}" class="flex items-center">
                        ...
                        <span
                            class="mx-2 {{ Request()->is('approve_campaign') ? 'text-white' : 'text-black' }} {{ Request()->is('approve_campaign') ? 'in_active' : '' }} text-xl font-bold" style="position:absolute;margin-left:30px !important;">Approve
                            Campaign</span>
                        @if ($Camp_Data != '')
                        <span class="static-badge" style="margin-left: 190px;color:white !important;">
                                {{ $Camp_Data }}
                            </span>
                        @endif
                    </a>
