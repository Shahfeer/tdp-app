    ...
    <label class="text-lg uppercase font-medium text-gray-800 block mb-2 dark:text-gray-300" 
       ...
       <!--Prompt File Upload and Date -->
            <div class="-mx-3 flex mb-6" style="margin-right:400px !important;">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    <label class="custom-label text-lg uppercase font-medium text-gray-800 block mb-2 dark:text-gray-300" for="upload_audio_file" style="text-align: right; line-height: 42px; font-size: medium;margin-left:20px !important;">
            ...
            <label style="color: #FF0000;">*</label> [?]
                ...
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-2 px-3 mb-1" 
                        ...
                        title="Upload MP3 / WAV file" accept="audio/mpeg, audio/wav" style="width: 500px;margin-left:11px;"
                        data-toggle="tooltip" data-placement="top" data-html="true" title="" autocomplete="off">

                        <div id="file_error" class="error-message" style="margin-left:11px;"></div>
                <span class="text-sm text-sky-500" style="margin-left:11px;">The file must be MP3 or Wav.</span>
                </div>
            </div>
