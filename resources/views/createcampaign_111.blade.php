        ...
        if (extn != '' && extn != 'NULL') 
        {
            ...
            reader.onload = function(e) 
            {
                ...
                if ($("#non_customised").is(":checked")) 
                {
                    ...
                    var errorMessage = 'File should have only mobile numbers.';
                } 
                else if ($("#customised").is(":checked")) 
                {
                    console.log("customised");
                    var expectedColumns = 2;
                    var errorMessage = 'File should have mobile number, and audio URL.';
                } 
                else 
                {
                    var expectedColumns = null;
                    var errorMessage = 'Invalid file format. Please upload a valid file.';
                }
    ...
    <form action="{{ route('file-import') }}" method="POST" name="campaign_form" id="campaign_form" onsubmit="return validateForm()" enctype="multipart/form-data">
        ...
        <div class="- mx-3 flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                <label class=" text-lg uppercase font-medium text-gray-800 block mb-2 dark:text-gray-300" for="user_avatar" style="text-align: right; line-height: 42px;">Customised OBD<span style="color: #ff0000">*</span></label>
            </div>
            ...
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
	          ...
	          <div class="md:w-1/2 px-3 mb-6 md:mb-0">
		          <div class="flex items-center">
                      ...
                      <a id="download_sample_link" href="#" download class=" md:w-full mt-7 bg-gray-900  text-white py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full" download style="margin-top: -4px; width: 200px; text-align: center; margin-left: 10px">Download Sample</a>
        ...
        <div class="-   mx-3 md:flex mb-6">
            ...
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                <label class=" text-lg uppercase font-medium text-gray-800 block mb-2 dark:text-gray-300" for="user_avatar" style="text-align: right; line-height: 42px;">
                    Retry Time Interval<span style="color: #ff0000">*</span>
                </label>
		        </div>
		        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                <input type="text" name="retry_time" id="retry_time" class="w-full bg-gray-200 text-black border border-gray-200 rounded py-2 px-3 mb-1" style="width: 300px; float: left" autocomplete="off" placeholder="Min. 900 Secs & Max. 3600 Secs">
                    <br><br>
