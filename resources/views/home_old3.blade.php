...
?>
    ...
    @if(Auth::user()->user_master_id != 1)
        ...
        <div class="card" style="margin-top:10px">
            <div class="px-3 flex flex-wrap" style="background-color: #FFF; height: 20px; padding-top: 10px; margin-bottom: 20px;">
            <div style="width:60%"> <h2 class="text-2xl font-bold">Last 3 Day's Campaign</h2> </div>
            <div style="width:40%"> <h2 style=" text-align: center" class="text-2xl font-bold">Last one Week's Campaign</h2></div>
            </div>
...
//         console.log(failureData);
    ...
    lastThreeDaysData.forEach(data => {
        ...
        //     if(maxDataValue < 200000)
        //     {
        //         console.log("less than 20000")
        //         yAxisScale = 20000;

        //          // Update the dropdown menu to reflect the available options
        //         const yAxisScaleSelect = document.getElementById('yAxisScale');
        //         yAxisScaleSelect.innerHTML = ''; // Clear existing options

        //          // Add options dynamically based on the determined scale
        //         [20000, 200000, 400000, 500000].forEach(scale => {
        ...
        //          // Add options dynamically based on the determined scale
        //         [200000, 400000, 500000].forEach(scale => {
        //             const option = document.createElement('option');
        //             option.value = scale;
        //             option.textContent = scale.toLocaleString(); // Format scale with commas
        //             if (scale === yAxisScale) {
