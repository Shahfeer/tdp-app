...
<span class="tooltip-campaign" data-campaign-id="123">Neron ID</span> -->
    ...
    .custom-height {
        height: 6.3rem; /* or any other value like 16.4em or 16.4px */
    }
...
@include('includes.sidebar')
			...
			<!-- Left side with hamburger menu -->
				...
				@php
                        	...
                        	<div style="font-weight: bold; text-transform: uppercase; margin-left: 10px; text-align: right;"">
                            		@if ($userMasterId == 2)
                                		<span style="color: blue;">Available Credits: {{ $available_credits }}</span>
                            		@endif
                        	</div>
				...
				<div style="font-weight: bold; float: left; color: blue;"
