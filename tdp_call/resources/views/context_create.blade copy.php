...
<div class="w-full bg-white shadow-md rounded-lg px-8 pt-6 pb-8 mb-4 flex flex-col">
    <div class="px-3" style="background-color: #FFF; text-align: center; color: black; height: 50px; padding-top: 2px; margin-bottom: 6px;">
        ...
        @csrf
          ...
          <div class="- mx-3 flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                 <label class=" text-lg uppercase font-medium text-gray-800 block mb-2 dark:text-gray-300" for="user_avatar" style="text-align: right; line-height: 42px; font-size: medium;">Customised OBD<span style="color: #ff0000">*</span></label> 
            </div>
            <div class="md:w-1/2 px-3 mb-6 md:mb-0 flex">
                <div class="mr-4 flex items-center">
                    <input type="radio" name="campaign_type" id="customised" checked value="C">
                    <label for="static" class="ml-2">Yes</label>
                </div>
        
                <div class="mr-4 flex items-center">
                     <input type="radio" name="campaign_type" id="non_customised" value="N" checked>
       ...
       <!--Prompt File Upload and Date -->
        <div class="-mx-3 flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                Upload prompt<span style="color: #ff0000">*</span> <span style="font-size: smaller; color: blue;">(MP3 / WAV)</span>
                </label>
            </div>
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                <input class="w-full bg-gray-200 text-black border border-gray-200 rounded py-2 px-3 mb-1" 
                    ...
                    title="Upload MP3 / WAV file" accept="audio/mpeg, audio/wav" style="width: 300px;"
