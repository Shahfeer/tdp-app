                ...
                @endif">
                    <div class="flex-auto p-4">
                        <div class="flex flex-wrap" style = "height: 150px;">
                            <div class="relative w-full" style="text-align: center;">
    ...
    @if(Auth::user()->user_master_id != 1)
        ...
        <div class="card" style="margin-top:30px">
            <div class="px-3" style="background-color: #FFF; height: 50px; padding-top: 8px; margin-bottom: 20px;">
                <h2 class="text-2xl font-bold">Last One Week's Campaign Summary</h2>
            </div>

            <div class="card-header" style="background-color:#fff">
                <div class="flex flex-wrap">
                    <div class="w-full md:w-1/2 px-4">
                        <div style="height:550px;width:130%;background-color:#fff">
                            <canvas id="barChart"></canvas>
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 px-4">
                        <div style="height:300px;width:100%;max-width:900px;background-color:#fff">
