...
<div><img src="https://yourpostman.in/whatsapp_report_portal/assets/img/cm-logo.png" alt="logo" style=" width: 75%;"> </div>
    ...
    <!-- <div class="min-h-screen flex items-center  bg-red-200">
        <div class="bg-white w-full max-w-lg rounded-lg shadow overflow-hidden mx-auto"> -->
            <div class="py-4 px-6">
              ...
              <div class="mt-1 text-center font-bold text-gray-900 text-xl" style="font-weight: 900;">OBD Call - Create New Account</div>
    ...
    <div class="alert alert-success" style="color:red; font: weight 700px;">
        {{ session()->get('message') }}
    </div>
@endif
            ...
            <div class="flex items-center justify-center py-4 bg-gray-100 text-center" style="background-color: #00ee5a !important; color:black !important;">
                <h1 class="text-white-600 text-sm" style=" font-family: 'Nunito', sans-serif !important;">Already have account?</h1>
                <a href="{{ route('login') }}" class="text-white-600 font-bold mx-2 text-sm hover:text-white-400 underline" style="font-weight: 1000 !important;">Login</a>
...
<script>
    document.getElementById('registration-form').addEventListener('submit', function(event) {
        ...
        fetch(this.action, {
            ...
            body: formData,
            headers: {
                'X-Requested-With': 'XMLHttpRequest', // Optional, if you want to handle AJAX
        ...
        .then(data => {
            if (data.message) {
                ...
                successMessage.classList.remove('hidden'); // Remove hidden class to show it
            }
        })
        .catch(error => {
