...
<aside class="w-full md:w-64 bg-gray-800 md:min-h-screen menu_list" x-data="{ isOpen: false }"
    ...
    <!-- Sidebar Navigation -->
    <div class="px-2 py-6 md:block " :class="isOpen ? 'block' : 'hidden'" style="width: 350px;" id= "content">
        <ul>

            <!-- Home page redirect -->
            <li class="px-2 py-3 hover:bg-red-900 {{ Request()->is('home') ? 'in_active' : '' }} rounded-lg home">
                <a href={{ route('home') }} class="flex items-center">
                    <svg class="w-6 {{ Request()->is('home') ? 'text-white' : 'text-black' }} {{ Request()->is('home') ? 'in_active' : '' }} "
                    ...
                    <span
                        class="mx-2 {{ Request()->is('home') ? 'text-white' : 'text-black' }} {{ Request()->is('home') ? 'in_active' : '' }} text-xl font-bold ">Dashboard</span>
                </a>
            </li>
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('gsm_board') }}" class="flex items-center">
                        <svg class="h-8 w-8 {{ Request()->is('gsm_board') ? 'text-white' : 'text-black' }} {{ Request()->is('gsm_board') ? 'in_active' : '' }}"
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('credit_management') }}" class="flex items-center">
                        <svg class="w-6 {{ Request()->is('credit_management') ? 'text-white' : 'text-black' }} {{ Request()->is('credit_management') ? 'in_active' : '' }}"
                            fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li
                ...
                <a href="{{ route('context_create') }}" class="flex items-center">
                    <svg class="h-8 w-8 {{ Request()->is('context_create') ? 'text-white' : 'text-black' }} {{ Request()->is('context_create') ? 'in_active' : '' }}"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
            ...
            <li
                ...
                <a href="{{ route('context_list') }}" class="flex items-center">
                    <svg class="h-8 w-8 {{ Request()->is('context_list') ? 'text-white' : 'text-black' }} {{ Request()->is('context_list') ? 'in_active' : '' }}"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('ivr_approve') }}" class="flex items-center">
                        <svg class="h-8 w-8 {{ Request()->is('ivr_approve') ? 'text-white' : 'text-black' }} {{ Request()->is('ivr_approve') ? 'in_active' : '' }}"
            ...
            <li
                ...
                <a href="{{ route('createcampaign') }}" class="flex items-center">
                    <svg class="h-8 w-8 {{ Request()->is('createcampaign') ? 'text-white' : 'text-black' }} {{ Request()->is('createcampaign') ? 'in_active' : '' }}"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                        fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" />
                        <path
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('approve_campaign') }}" class="flex items-center">
                        <svg class="h-8 w-8 {{ Request()->is('approve_campaign') ? 'text-white' : 'text-black' }} {{ Request()->is('approve_campaign') ? 'in_active' : '' }}"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx="12" cy="12" r="9" />
                        ...
                        <span
                            ...
                            Campaign</span>
                        @if ($Camp_Data != '')
                            <span class="static-badge" style="margin-left: 60px;">
                                {{ $Camp_Data }}
                            </span>
                        @endif
                    </a>
            ...
            <li
                ...
                <a href="{{ route('campaign_list') }}" class="flex items-center">
                    <svg class="w-6 {{ Request()->is('campaign_list') ? 'text-white' : 'text-black' }} {{ Request()->is('campaign_list') ? 'in_active' : '' }}"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path
            ...
            @if (Auth::user()->user_master_id == 1)
                ...
                <li
                    ...
                    <a href="{{ route('cdr_generation') }}" class="flex items-center">
                        <svg class="h-8 w-8 {{ Request()->is('cdr_generation') ? 'text-white' : 'text-black' }} {{ Request()->is('cdr_generation') ? 'in_active' : '' }}"
                            width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                            stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" />
                            <circle cx="12" cy="12" r="9" />
            ...
            <li
                ...
                <a href="{{ route('summaryreport') }}" class="flex items-center">
                    <svg class="w-6 {{ Request()->is('summaryreport') ? 'text-white' : 'text-black' }} {{ Request()->is('summaryreport') ? 'in_active' : '' }}"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <!-- <path
            ...
            <li
                ...
                <a href="{{ route('summary_report') }}" class="flex items-center">
                    <svg class="w-6 {{ Request()->is('summary_report') ? 'text-white' : 'text-black' }} {{ Request()->is('summary_report') ? 'in_active' : '' }}"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <!-- <path
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path> -->
            ...
            <li
                ...
                <a href="{{ route('detailreport') }}" class="flex items-center">
                    <svg class="w-6 {{ Request()->is('detailreport') ? 'text-white' : 'text-black' }} {{ Request()->is('detailreport') ? 'in_active' : '' }}"
                        fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <!--  <path
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path> -->
                    ...
                    <span
                        class="mx-2 {{ Request()->is('detailreport') ? 'text-white' : 'text-black' }} {{ Request()->is('detailreport') ? 'in_active' : '' }} text-xl font-bold">Detail
                        Report</span>
                </a>
